...
\begin{deluxetable*}{lrrrh}
    ...
    \startdata
    %%
    ~~~$P$ (days)             \dotfill    & $4.8101025_{-0.00000033}^{+0.00000043}$ & x & y & z \\
    ~~~$T_c$ (${\rm BJD}$)  \dotfill    & $2455961.38467_{-0.00064}^{+0.00076}$ & x & y & z \\
    ~~~$T_{14}$ (days)  \dotfill    & $0.2912 \pm 0.0019$ & x & y & z \\
    ~~~$T_{12} = T_{34}$ (days)  \dotfill    & $0.0229\pm0.0010$ & x & y & z \\
    ~~~$\arstar$              \dotfill    & $5.691_{-0.124}^{+0.057}$ & x & y & z \\
    ~~~$\rpl/\rstar$          \dotfill    & $0.0834\pm0.0017$ & x & y & z \\
    ~~~$b \equiv a \cos i/\rstar$
    \dotfill    & $0.12_{-0.08}^{+0.12}$ & x & y & z \\
