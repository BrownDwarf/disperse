...
The predicted Helium ionization depends sensitively on the XUV flux \citep{2019ApJ...881..133O}.  Few XUV measurements exist for F stars, with the F7IV-V \object[tau Boo]{$\tau$ Boo} serving as the closest analog \citep{2011A&A...532A...6S}.  \hatp resides closer to the Kraft break than does \object[tau Boo]{$\tau$ Boo}, which may be associated with rapid changes in the stellar wind and other atmospheric changes leading to much lower XUV flux.  We explore incident XUV fluxes of $100\times$ higher and lower than \object[tau Boo]{$\tau$ Boo} to gauge the sensitivity.  Figure XX shows the range of conceivable XUV SEDs.
