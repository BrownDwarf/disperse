...
The excess absorption appears deepest and with the narrowest line width at the moment of ingress.  Gas overfilling the stellar disk does not contribute to the excess absorption, and so the ratio of the vertical component of the intial velocity of the gas (perpendicular to the orbital plane) to the Keplerian shear controls how much time a given gas parcel has before it leaves the projected orbital chord.
