...
\authorcomment1{The entire suite of project files, reproducible Jupyter Notebooks, selected data files, and revision history are publically available as a reproducible GitHub repository\footnote{\url{https://github.com/BrownDwarf/disperse}}.}
