...
We retrieved 22 epochs of archival \emph{Keck HIRES} spectra via the Keck Observatory Archive (KOA). Of these, 19 were acquired through the iodine cell as reported by \citet{2017AJ....153..211Z}, providing RV orbit constraints.  Only 8 were acquired with the B5 decker, with the rest through the C2 decker.  The 14\arcsec slit height of the C2 decker appears to cause order overlap in \ion{Ca}{2} H and K lines, which contaminated the spectral extraction.  The 3.5\farcs B2 deck   Most of the spectra were acquired with the C2 decker
