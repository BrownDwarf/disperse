...
Figure \ref{fig:centroids} shows the centroid positions of the Helium excess feature.  The bulk velocity drifts of the planet outflow can be seen with a few conspicuous trends.  The pre-transit phases ($-0.3$ - $+0.03$) show a slight tendency towards blueshift relative to stellar restframe, with an accelerating blueshift from phases ($-0.3$ - $-0.15$), albeit with some visit-to-visit scatter.  The post-transit observations ($+0.03$ - $+0.015$) exhibit weak-albeit-significant equivalent widths, as denoted by their smaller marker size.  The centroids dramatically accelerate to larger bulk blueshifts, as low as 10831 \AA.
...
\authorcomment1{Describe the velocity structure}
