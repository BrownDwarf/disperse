...
\begin{figure}
    ...
    \caption{Line centroid positions of the  10830 triplet.  \emph{left}: The overview panel shows a slight blueshift relative to the stellar restframe, and a weak excess blueshift trend after planet egress. \emph{right:} The detailed zoom-in of the in-transit phase shows a redshift relative to the planet restframe at ingress and a blueshift relative to the planet restframe near egress.  The line-of-sight velocity distribution of 2-3 \AA means that the gas distribution exhibits both advancing and receding lobes at all phases other than post-egress.}
    \label{fig:example}
\end{figure}
