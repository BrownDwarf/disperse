...
We assembled a composite lightcurve from TESS Sectors 24, 26, 51, 52, 53, which were reduced with the default SPOC pipeline \citep{2020RNAAS...4..201C}.  These TESS data exhibit a native RMS scatter of better than 1 part-per-thousand (ppt).  We fit a Keplerian orbit model to the TESS lightcurve using the \texttt{exoplanet} framework \citep{exoplanet:joss}.
