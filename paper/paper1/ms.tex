...
\begin{deluxetable}{chc}
    ...
    \tablehead{
        \colhead{Reference} & \nocolhead{Other Column} & \colhead{Key idea}
    }
    \startdata
...
\begin{figure}
    \includegraphics[width=\linewidth]{stellar_periodogram.png}
    \caption{Periodogram of solely the stellar variation of the flux. }
    \label{fig:stellar_periodogram}
\end{figure}

\begin{figure}
    \includegraphics[width=\linewidth]{planetary_periodogram.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{TESS_EW_HAT-P-67.jpg}
    \caption{A boat.}
    \label{fig:boat1}
\end{figure}
